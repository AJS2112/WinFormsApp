...
namespace AppCaja.Dialogs
{
    public partial class frmCajMovimientoSelection : MetroFramework.Forms.MetroForm
    {
        ...
        private void CalcularTotales()
        {
            ...
            if (instrumentosSeleccionados.Count > 0)
            {
                for (var i = 0; i < instrumentosSeleccionados.Count; i++)
                {
                    ...
                    instrumentosSeleccionados[i].monto_moneda = instrumentosSeleccionados[i].monto * factor;
                }
            }
        ...
        {
            int valor;
            if (int.TryParse(txtTasa.Text, out valor))
            {
                factor = valor;
                CalcularTotales();
            }
        ...
        private void txtTasa_Click(object sender, EventArgs e)
        {
